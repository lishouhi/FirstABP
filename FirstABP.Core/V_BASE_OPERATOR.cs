...
{
	[Serializable]
	public class V_BASE_OPERATOR
	{
		#region Constructor
		public V_BASE_OPERATOR() { }

		public V_BASE_OPERATOR(Int64 bIG_OPERATOR_AUID,String nVR_NAME,String nVR_PASSWORD,String nVR_AUTHORIZE,DateTime dTE_CREATE_DATE,DateTime dTE_LAST_LOAD_DATE,String nVR_LAST_LOAD_IP,Int32 iNT_IS_LOCK,Int64 bGT_ROLE_AUID,String nVR_ROLE_NAME)
		{
			...
			this.nVR_ROLE_NAME = nVR_ROLE_NAME;
		}
		#endregion
		...
		private String nVR_ROLE_NAME;

		public String NVR_ROLE_NAME
		{
			get { return nVR_ROLE_NAME; }
			set { nVR_ROLE_NAME = value; }
		}
		#endregion
		...
		{	
			...
			if (this.NVR_ROLE_NAME != null && 64 < this.NVR_ROLE_NAME.Length)
			{
				validatorResult = false;
				this.ErrorList.Add("The length of NVR_ROLE_NAME should not be greater then 64!");
			}
