...
{
	[Serializable]
	public class MFT_GENDECL_STATISTICS_HISTORY
	{
		#region Constructor
		public MFT_GENDECL_STATISTICS_HISTORY() { }

		public MFT_GENDECL_STATISTICS_HISTORY(Int32 iNT_YEAR,Int32 iNT_HALFYEAR,Int32 iNT_QUARTER,Int32 iNT_MONTH,Int32 iNT_DAY,Int64 bIG_ENTERPRISE_AUID,String nVR_CN_NAME,String nVR_CUSTOMS_CODE,Int32 iNT_MANIFEST_COUNT,Int32 iNT_BL_COUNT,Int32 iNT_TOTAL_COUNT,Decimal dEC_PRICE,Decimal dEC_TOTAL_CHARGES,DateTime dTE_CREATE_DATE,Int32 iNT_CHARGE_BACK_MODE,DateTime dTE_CREATE_TIME)
		{
