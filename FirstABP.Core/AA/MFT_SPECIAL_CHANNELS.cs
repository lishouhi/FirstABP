...
{
	[Serializable]
	public class MFT_SPECIAL_CHANNELS
	{
		#region Constructor
		public MFT_SPECIAL_CHANNELS() { }

		public MFT_SPECIAL_CHANNELS(Int64 bIG_SPECIAL_CHANNELS_AUID,Int64 bIG_ENTERPRISE_AUID,DateTime dTE_START_DATE,DateTime dTE_END_DATE,Int64 bIG_OPERATOR_AUID,Boolean bIT_IS_VALID,String nVR_REMARK,DateTime dTE_CREATE_DATE)
		{
