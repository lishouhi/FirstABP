...
{
	[Serializable]
	public class CIQ_SHIPDECL_FREEZE
	{
		#region Constructor
		public CIQ_SHIPDECL_FREEZE() { }

		public CIQ_SHIPDECL_FREEZE(Int64 bIG_ENTERPRISE_AUID,String nVR_SHIP_ID,String nVR_VOYAGE_NO,Decimal dEC_MONEY,String nVR_ORG_CODE,DateTime dTE_DECLARE,String nVR_DECLARE_PERSON,String nVR_REMARK,DateTime dTE_CREATE_DATE,String nVR_CREATE_PERSON,Int32 iNT_I_OR_E)
		{
